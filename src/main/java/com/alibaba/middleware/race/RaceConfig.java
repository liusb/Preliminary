...
public class RaceConfig implements Serializable {
    ...
    //这些是写tair key的前缀
    public static String prex_tmall = "platformTmall_349101bfdy_";
    public static String prex_taobao = "platformTaobao_349101bfdy_";
    public static String prex_ratio = "ratio_349101bfdy_";


    //这些jstorm/rocketMq/tair 的集群配置信息，这些配置信息在正式提交代码前会被公布
    public static String JstormTopologyName = "349101bfdy";

    public static String MqConsumerGroup = "349101bfdy";
